...
const CourseCurriculum = () => {
    ...
    const { currentCourse, status, completedLessons = [] } = useSelector(
        (state) => state.school
    );
    ...
    */
    ...
    /*
    ----------------------------------------------------
    Derive first lesson safely
    ----------------------------------------------------
    */

    const firstTopic = useMemo(() => {
        return currentCourse?.topics?.[0] ?? null;
    }, [currentCourse]);

    const firstLesson = useMemo(() => {
        return firstTopic?.lessons?.[0] ?? null;
    }, [firstTopic]);
    ...
    }, [firstLesson, firstTopic, activeLesson]);
    ...
    const findNextLesson = () => {
        ...
        const index = allLessonsFlat.findIndex(
            (lesson) => lesson.id === activeLesson.id
        );

        if (index >= 0 && index < allLessonsFlat.length - 1) {
            return allLessonsFlat[index + 1];
        }
        ...
        try {
            ...
            if (nextLesson) {
                ...
                setTimeout(() => {
                    ...
                    const parentTopic = currentCourse.topics.find(
                        topic => topic.lessons.some(
                    ...
                    if (
                        parentTopic &&
                        !expandedTopics.includes(parentTopic.id)
                    ) {
                        setExpandedTopics(prev => [
                            ...prev,
                            parentTopic.id
                            ...
                            <div key={topic.id}>
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <span className="text-[13px] font-black text-left leading-tight">
                                            {topic.title}
                                        </span>
            ...
            <main className="flex-1 overflow-y-auto bg-white relative">
                ...
                {activeLesson ? (
                    ...
                    <div className="max-w-4xl mx-auto p-8 lg:p-16 space-y-10 pb-40">
                        ...
                        <div className="relative aspect-video bg-slate-900 rounded-[3rem] shadow-2xl overflow-hidden border-8 border-white">
